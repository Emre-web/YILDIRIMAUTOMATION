  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-950 via-purple-950/20 to-black">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center pt-20 sm:pt-0">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/20 text-slate-300 text-base font-mono mb-12 tracking-wide backdrop-blur-sm shadow-lg shadow-green-500/20">
          <span className="w-2 h-2 rounded-full bg-green-500 animate-pulse shadow-lg shadow-green-500"></span>
          <span className="font-sans">{t.availableForProjects}</span>
        </div>
